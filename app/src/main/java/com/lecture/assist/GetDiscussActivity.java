...
public class GetDiscussActivity extends BaseActivity {
    ...
    public void init(){
        xuanshangGetBankImage = findViewById(R.id.xuanshang_get_bank_image);
        getDiscussAvator = findViewById(R.id.get_discuss_avator);
        discussGetNameText = findViewById(R.id.discuss_get_name_text);
        discussGetTimeText = findViewById(R.id.discuss_get_time_text);
        discussGetScore = findViewById(R.id.discuss_get_score);
        getDiscussText = findViewById(R.id.get_discuss_text);
        getDiscussEdit = findViewById(R.id.get_discuss_edit);
        getDiscussImage = findViewById(R.id.get_discuss_image);
        getDiscussRecycler = findViewById(R.id.get_discuss_recycler);

        xuanshangGetBankImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                onXuanshangGetBankImageClicked();
            }
        });

        getDiscussImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                onGetDiscussImageClicked();
            }
        });
    }
