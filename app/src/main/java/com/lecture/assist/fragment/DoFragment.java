...
import com.lecture.assist.GetDiscussActivity;
import com.lecture.assist.R;
import com.lecture.assist.SendDiscussActivity;
import com.lecture.assist.SignedActivity;
import com.lecture.assist.adapter.DoAdapter;
...
public class DoFragment extends BaseFragment implements RapidFloatingActionContentLabelList.OnRapidFloatingActionContentLabelListListener {
    ...
    protected void init(View mView, Bundle mSavedInstanceState) {
        doTitleText = mView.findViewById(R.id.do_title_text);
        doRecyclerView = mView.findViewById(R.id.do_recycler_view);
        doFbtn = mView.findViewById(R.id.do_fbtn);
        doFbtnLayout = mView.findViewById(R.id.do_fbtn_layout);
    }
